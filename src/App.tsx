...
const RankGuard: React.FC<{
  allowed: Array<'owner' | 'superadmin' | 'admin' | 'teacher'>;
  children: React.ReactNode;
}> = ({ allowed, children }) => {
  const { user, isOwner, isSuperAdmin, isAdmin, isTeacher } = useAuth();
  ...
  const rankAllowed =
    (allowed.includes('owner') && isOwner) ||
    (allowed.includes('superadmin') && isSuperAdmin && !isOwner) ||
    (allowed.includes('admin') && isAdmin && !isSuperAdmin) ||
    (allowed.includes('teacher') && isTeacher);
      ...
      <BrowserRouter>
        <Routes>
          ...
          <Route element={<AppLayout />}>
            ...
            />
            <Route path="/owner" element={<RankGuard allowed={['owner']}><OwnerDashboard /></RankGuard>} />
            <Route path="/owner/security" element={<RankGuard allowed={['owner']}><OwnerSecurity /></RankGuard>} />
            <Route path="/owner/analytics" element={<RankGuard allowed={['owner']}><OwnerAnalytics /></RankGuard>} />
            <Route path="/owner/settings" element={<RankGuard allowed={['owner']}><OwnerSettings /></RankGuard>} />

            <Route path="/superadmin" element={<RankGuard allowed={['superadmin', 'owner']}><SuperAdminDashboard /></RankGuard>} />
            <Route path="/superadmin/users" element={<RankGuard allowed={['superadmin', 'owner']}><UserManagement /></RankGuard>} />
            <Route path="/superadmin/platform" element={<RankGuard allowed={['superadmin', 'owner']}><PlatformControl /></RankGuard>} />

            <Route path="/admin/dashboard" element={<RankGuard allowed={['admin', 'superadmin', 'owner']}><AdminDashboard /></RankGuard>} />
            <Route path="/admin/reports" element={<RankGuard allowed={['admin', 'superadmin', 'owner']}><AdminReports /></RankGuard>} />

            <Route path="/teacher" element={<RankGuard allowed={['teacher']}><TeacherDashboard /></RankGuard>} />
